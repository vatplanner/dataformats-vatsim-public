...
public class VoiceServer {
    ...
    /**
     * Returns the server name. The name is not the server's address/host name but
     * may actually contain a longer description text.
     *
    ...
    /**
     * Returns the raw (uninterpreted) information about the type of voice server.
     * Unfortunately, there is no publicly documented information on what this
     * means, so expect this to be anything and of no use unless you are writing a
