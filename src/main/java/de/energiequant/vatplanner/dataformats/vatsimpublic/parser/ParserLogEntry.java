...
public class ParserLogEntry {
     ...
     * @param isLineRejected Has line been rejected (was line deemed
     * unparseable)?
    ...
    /**
     * Indicates if the line had to be rejected. Evaluate all log entries for
     * this flag to check if a file contained any significant errors.
     * <p>
     ...
     * could still mean that another log entry exists for the same line which
     * caused the line to actually have been rejected.
     * </p>
     *
     * @return Has the line been rejected by parser? (true = rejected; if false,
     * you still may want to check other entries)
     */
     ...
     * during parsing. Just holding a {@link Throwable} does not indicate a
     * fatal error which resulted in rejection of a line. Instead, check
