...
public enum FacilityType {
     ...
     * runways).
     * Ground service includes Delivery if a dedicated station is offline
     * (top-bottom service).
     */
    GROUND(3),
     ...
     * well as runways on ground.
     * Tower service includes Ground and Delivery if dedicated stations are
