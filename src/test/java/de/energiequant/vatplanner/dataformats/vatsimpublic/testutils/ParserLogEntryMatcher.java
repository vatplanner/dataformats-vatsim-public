package de.energiequant.vatplanner.dataformats.vatsimpublic.testutils;

import de.energiequant.vatplanner.dataformats.vatsimpublic.parser.ParserLogEntry;
 ...
 * {@link ParserLogEntry}.
 * Can be instantiated either directly by constructor or by "naturally named"
 * static method {@link matchesParserLogEntry}.
 */
public class ParserLogEntryMatcher extends TypeSafeMatcher<ParserLogEntry> {
     ...
     * {@link ParserLogEntry}.
     * @param sectionMatcher matcher to be applied to {@link ParserLogEntry#getSection()}
     * @param lineContentMatcher matcher to be applied to {@link ParserLogEntry#getLineContent()}
     * @param isLineRejectedMatcher matcher to be applied to {@link ParserLogEntry#isLineRejected()}
     * @param messageMatcher matcher to be applied to {@link ParserLogEntry#getMessage()}
     * @param throwableMatcher matcher to be applied to {@link ParserLogEntry#getThrowable()}
     */
     ...
     * @param attributeDescription description of attribute matcher belongs to (will be used as prefix to matcher description)
